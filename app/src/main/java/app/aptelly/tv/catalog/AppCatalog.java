...
public final class AppCatalog {
    ...
    public static List<CatalogApp> globalServices() {
        return Arrays.asList(
                ...
                app("YouTube TV", R.string.desc_subscription_global,
                        "com.google.android.apps.youtube.unplugged",
                        R.drawable.brand_youtube, 234, 51, 35, 91, 14, 20,
                        true, true),
                app("discovery+", R.string.desc_subscription_global,
                        "com.discovery.discoveryplus.mobile", R.drawable.brand_discovery,
                        19, 185, 219, 24, 65, 124, false, true),
                app("Sling TV", R.string.desc_free_streaming,
                        "com.sling", R.drawable.brand_sling,
                        20, 119, 255, 4, 43, 116, false, true),
                app("Fubo", R.string.desc_sports_global,
                        "tv.fubo.mobile", R.drawable.brand_fubo,
                        239, 89, 45, 120, 24, 64, true, true),
                app("ESPN", R.string.desc_sports_global,
                        "com.espn.score_center", R.drawable.brand_espn,
                        225, 31, 38, 98, 7, 12, false, true),
                app("F1 TV", R.string.desc_sports_global,
                        "com.formulaone.production", R.drawable.brand_f1,
                        232, 0, 45, 54, 8, 19, false, true),
                app("MUBI", R.string.desc_subscription_global,
                        "com.mubi", R.drawable.brand_mubi,
                        19, 19, 21, 0, 0, 0, false, false),
                app("BritBox", R.string.desc_subscription_global,
                        "com.britbox.tv", R.drawable.brand_britbox,
                        20, 44, 96, 83, 24, 126, false, false),
    ...
    public static List<CatalogApp> chinaMainlandServices() {
        return Arrays.asList(
                ...
                chinaApp("芒果TV", R.string.desc_mango_tv,
                        "com.hunantv.license", R.drawable.brand_mango_tv,
