...
public final class CatalogApp {
    ...
    public boolean supportsOneClickInstall() {
        // Platform-store cards can still be installed through another managed
        // store that is already present on the television. The direct matcher
        // runs first; StoreInstallRouter owns the package-specific fallback.
        return source != Source.WEB;
    }
